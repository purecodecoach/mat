...
export const setCookies = (key, data, options) => {
...
export const deleteCookie = (key, options) => {
    return setCookie(key, '', Object.assign(Object.assign({}, options), { maxAge: -1 }));
};
...
export const hasCookie = (key, options) => {
    if (!key)
        return false;
    const cookie = getCookies(options);
    return cookie.hasOwnProperty(key);
};
export const checkCookies = (key, options) => {
